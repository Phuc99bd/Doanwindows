...
namespace QuanlyNhahang.QLNHDataSet1TableAdapters {
...
SELECT ID, Name, IdCategory, Price FROM Food WHERE (ID = @ID) AND (Name = @Name)";
        ...
        public virtual int Fill(QLNHDataSet1.FoodDataTable dataTable) {
        ...
        public virtual QLNHDataSet1.FoodDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLNHDataSet1.FoodDataTable dataTable = new QLNHDataSet1.FoodDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLNHDataSet1.FoodDataTable dataTable) {
